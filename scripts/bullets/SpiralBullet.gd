...
@export var segmentos:int = 7
@export var minPoints:int = 24
@export var maxPoints:int = 128  # valor por defecto más conservador
@export var update_interval: float = 0.012  # segundos entre actualizaciones (throttle)
